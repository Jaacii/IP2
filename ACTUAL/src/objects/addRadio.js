function addRadio() {
    ...
    var materialArray2 = [lautsprecherteilMaterial, lautsprecherteilMaterial, lautsprecherteilMaterial, lautsprecherteilMaterial, lautsprecherMaterial, lautsprecherteilMaterial];
